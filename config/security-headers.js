...
const CONTENT_SECURITY_POLICY_DIRECTIVES = [
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.clarity.ms https://scripts.clarity.ms https://esm.sh https://www.designrush.com https://vai.me https://challenges.cloudflare.com",
...
const SECURITY_HEADERS = {
  ...
  'Permissions-Policy': 'camera=(), microphone=(), geolocation=(), payment=(), usb=(), bluetooth=(), midi=(), accelerometer=(), gyroscope=(), magnetometer=(), xr-spatial-tracking=(), display-capture=(), clipboard-read=(), clipboard-write=(self), fullscreen=(self), picture-in-picture=(), sync-xhr=(), hid=(), serial=(), screen-wake-lock=()',
