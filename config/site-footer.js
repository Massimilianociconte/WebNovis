...
function buildDirectoryBadgesHtml() {
  ...
  return `<a href="https://greatworkguild.com/listings/webnovis" target="_blank" rel="noopener" aria-label="WebNovis su Great Work Guild" style="display:inline-flex;align-items:center">${gwgImg}</a> <a href="https://www.webpronexus.com/italy/rho/branding-agency/web-novis?from=badge" title="Find me on The WebPro Nexus - Directory & Forum (list your Marketing & Web Design business & be found)" target="_blank" rel="noopener" aria-label="WebNovis su The WebPro Nexus" style="display:inline-flex;align-items:center">${wpnImg}</a> <a href="https://www.webdesignlistings.org/" rel="noopener" aria-label="WebNovis su Web Design Listings" style="display:inline-flex;align-items:center">Web Design Listings</a> <a href="https://listing.yaeris.com/company/webnovis?utm_source=trust_badge&utm_medium=referral&utm_campaign=yaeris_directory" target="_blank" rel="noopener" aria-label="WebNovis su Yaeris Directory" style="display:inline-flex;align-items:center;gap:8px;background:#0b0f14;border:1px solid #232833;border-radius:10px;padding:8px 14px;text-decoration:none;font-family:system-ui,-apple-system,sans-serif">${yaerisImg}<span style="color:#ffffff;font-size:12px;font-weight:600">Verified listing</span></a> <a href="https://www.pickanagency.com/agencies/webnovis?ref=pa-3ded50c9fd98c1d56f32910ad07a730b" rel="noopener" target="_blank" aria-label="WebNovis su Pick an Agency" style="display:inline-flex;align-items:center">Featured on Pick an Agency</a>`;
}
...
function normalizeFooterAssetMarkup(html) {
  ...
  if (footerBadgesMatch) {
    ...
    inner = inner.replace(/<a\b(?=[^>]*href=["']https:\/\/listing\.yaeris\.com\/company\/webnovis[^"']*["'])[^>]*>[\s\S]*?<\/a>/gi, '').trim();
